...
dat.GUI = dat.gui.GUI = function(e, a, c, d, f, b, n, h, j, m, l, o, y, g, i) {
    function q(a, b, r, c) {
        ...
        c.color ? b = new l(b,r) : (b = [b, r].concat(c.factoryArgs),
        b = d.apply(a, b));
    ...
    var x, F = true, v, A = false, G = [], k = function(a) {
        ...
        Object.defineProperties(this, {
            ...
            useLocalStorage: {
                ...
                set: function(a) {
                    u && ((e = a) ? g.bind(window, "unload", b) : g.unbind(window, "unload", b),
    ...
    i.extend(k.prototype, {
        ...
        onResize: function() {
            ...
            if (a.scrollable) {
                ...
                a.__ul.style.height = window.innerHeight - b - 20 + "px") : (g.removeClass(a.domElement, k.CLASS_TOO_TALL),
